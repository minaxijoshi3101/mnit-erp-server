...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id", resolver = EntityIdResolver.class, scope=CourseExtraCredit.class)
public class CourseExtraCredit implements Serializable{
	...
	private Long extraCreditsRequest;
	private Long extraCreditsApprove;
