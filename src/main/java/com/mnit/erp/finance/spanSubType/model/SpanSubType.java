package com.mnit.erp.finance.spanSubType.model;
...
/**
 * Contains span sub type model and its dependencies
 *
 * @author: Tejpal Singh
 * @return: Object of span sub type model
 * @date: 19 July, 2021
 */
@Data
@Entity
public class SpanSubType {
    @Id
